...
export const newsArticles: NewsArticle[] = [
  ...
  },
  {
    ...
    candidate: "a",
    candidateName: "山田あおい",
    headline: "山田候補「学食のバイト経験あり」発言に食い違いの指摘も",
    site: newsSite,
    date: "8/15",
    snippet: "過去の学内誌インタビューとの整合性を指摘する声がSNS上に。",
    body: [
      "山田あおい候補は演説で「自分自身、学食でのアルバイト経験がある」と語ったが、1年次に学内誌が行ったインタビューでは「アルバイトはしたことがない」と答えていたことが分かった。",
      "この食い違いについて、山田陣営は「学食運営委員としての活動を指してそう表現した」と説明している。",
      "些細な表現の差ではあるものの、SNS上では「気になる」「言葉は正確に使ってほしい」といった声も上がっている。",
    ],
  },
  {
