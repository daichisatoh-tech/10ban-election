...
export const candidateAPosts: Post[] = [
  ...
  },
  {
    id: "a3",
    date: "7/21",
    text: "政策の詳細を発表します!\n・日替わり定食 450円→350円\n・カレー 350円→250円\n・100円モーニング新設\n・営業時間20時まで延長\n年間200日通えば、2万円の節約に。みんなの毎日を、ちょっと軽くしたいです。",
    likes: 210,
    retweets: 64,
  },
  {
  ...
  },
  {
    id: "a5",
    date: "8/9",
    text: "「頑張った人だけが報われる」というけれど、頑張りたくても頑張れない事情を抱えている人だっています。みんなが安心して毎日を過ごせる大学の方が、私は好きです。100円は、人気取りじゃなくて、みんなの生活を守るための数字です。",
    quote: {
      color: "c",
      name: "西園寺隼人",
      handle: candidateCHandle,
      date: "7/30",
      text: "100円で買われてますよ‼️早く気づいて‼️‼️",
    },
    likes: 175,
    retweets: 58,
  },
...
export const candidateBPosts: Post[] = [
  ...
  },
  {
    id: "b4",
    date: "7/26",
    text: "100円の値下げ、聞こえはいいけど、その裏でメニューの質や品数が削られたら本末転倒じゃないかな。安さのためのコストカットが、結局みんなの「おいしい」を奪うことにならないか心配です。",
    quote: {
      color: "a",
      name: "山田あおい",
      handle: candidateAHandle,
      date: "7/21",
      text: "政策の詳細を発表します!日替わり定食450円→350円、カレー350円→250円に値下げします。年間200日通えば2万円の節約に。",
    },
    likes: 101,
    retweets: 47,
  },
  ...
  },
  {
    id: "b6",
    date: "8/16",
    text: "マジか。本当にこんなこと言われてるのか…。でも、こういう声があるからこそ、ちゃんと形にしないといけないんだと思う。がんばろ！！",
    quote: {
      color: "c",
      name: "西園寺隼人",
      handle: candidateCHandle,
...
export const candidateCPosts: Post[] = [
  ...
  },
  {
    id: "c6",
    date: "9/1",
    text: "好かれる政策を並べることだけの大学なんて情けない。本日正午、この大学の本当の闇を暴露する。この暴露の後、きっとあなたは投票先を変えるはずだ。",
    likes: 62,
    retweets: 73,
  },
  {
    id: "c7",
    date: "9/1",
    text: "山田陣営の「バイト経験なし＝謙虚アピール」ってやつ、あれ完全にファンが盛った作り話な。フェイクニュースに感動してる場合か。ちゃんと自分の目で確かめろ。",
    likes: 67,
    retweets: 95,
  },
];
